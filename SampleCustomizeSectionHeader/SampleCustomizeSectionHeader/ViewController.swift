...
//  SampleCustomizeSectionHeader
//
//  Created by RTC-HN158 on 5/9/17.
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.listBookTable.register(UINib(nibName: "HeaderView", bundle: nil), forHeaderFooterViewReuseIdentifier: "HeaderView")
    }
}
...
extension ViewController: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        headerView.title.text = "The Greatest Books Since)"
        headerView.year.text = "\(self.listYears[section])"
